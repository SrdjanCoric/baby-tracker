  ...
  useTranslation: () => ({
    t: (key, options) => {
      const translations = {
        ...
        "household.inviteCaregiver": "Invite a caregiver",
        "household.invitationDescription": "Enter the caregiver's account email, then send them the code. The invitation expires in 7 days.",
        "household.caregiverEmail": "Caregiver email",
        "household.caregiverEmailPlaceholder": "caregiver@example.com",
        "household.createInvitation": "Create invitation",
        "household.pendingInvitations": "Pending invitations",
        "household.noPendingInvitations": "No pending invitations",
        "household.invitationExpires": "Expires {{date}}",
        "household.copyInviteCode": "Copy code",
        "household.shareInviteCode": "Share code",
        "household.shareMessage": "Use this Sofi Baby Tracker invitation code: {{code}}. Sign in with the email address that was invited.",
        "household.replaceInvitation": "Replace code",
        "household.revokeInvitation": "Revoke",
        ...
        "household.invalidInvitation": "This invitation is invalid, expired, or not intended for this account",
