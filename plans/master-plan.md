...
- [ ] 0007 · Make authenticated activity sync lossless (after 0006) → tasks/0007-make-sync-queue-lossless.md
- [ ] 0008 · Target Watch actions to the requested baby (after 0006) → tasks/0008-target-watch-actions-to-the-requested-baby.md
- [ ] 0009 · Fix stale preference-driven UI and exports → tasks/0009-fix-stale-preference-driven-ui.md
