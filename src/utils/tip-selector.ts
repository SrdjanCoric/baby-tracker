...
function loadTipsForAgeGroup(ageGroup: string, locale: string): Tip[] {
  const tipsMap: Record<string, Record<string, Tip[]>> = {
    ...
    pt: {
      "2m": require("@/data/tips/pt/tips-2m.json"),
      "4m": require("@/data/tips/pt/tips-4m.json"),
      "6m": require("@/data/tips/pt/tips-6m.json"),
      "9m": require("@/data/tips/pt/tips-9m.json"),
      "1y": require("@/data/tips/pt/tips-1y.json"),
      "15m": require("@/data/tips/pt/tips-15m.json"),
      "18m": require("@/data/tips/pt/tips-18m.json"),
      "2y": require("@/data/tips/pt/tips-2y.json"),
      "30m": require("@/data/tips/pt/tips-30m.json"),
      "3y": require("@/data/tips/pt/tips-3y.json"),
      "4y": require("@/data/tips/pt/tips-4y.json"),
      "5y": require("@/data/tips/pt/tips-5y.json"),
    },
    sr: {
  ...
  const localeTips = tipsMap[locale] || tipsMap["en"];
